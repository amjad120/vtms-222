...
class scanOBD2_Only extends StatefulWidget {
  const scanOBD2_Only({super.key});

  @override
  State<scanOBD2_Only> createState() => _scanOBD2_OnlyState();
}

class _scanOBD2_OnlyState extends State<scanOBD2_Only> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Scan OBD2 Bluetooth')),
      body: Padding(
